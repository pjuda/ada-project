...
# Run this script in a directory of your choice where you want to download all the data.
# Careful! It will download in total 31 GB of data!

# SAMPLE CONTENT:
#wget https://s3.amazonaws.com/amazon-reviews-pds/tsv/sample_us.tsv
#wget https://s3.amazonaws.com/amazon-reviews-pds/tsv/sample_fr.tsv
...
wget https://s3.amazonaws.com/amazon-reviews-pds/tsv/amazon_reviews_us_Home_Improvement_v1_00.tsv.gz
...
#wget https://s3.amazonaws.com/amazon-reviews-pds/tsv/amazon_reviews_multilingual_DE_v1_00.tsv.gz
